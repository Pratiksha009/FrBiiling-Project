...
namespace DtDc_Billing.Entity_FR
{
    ...
    public partial class db_a92afa_frbillingEntities : DbContext
    {
        ...
        public virtual DbSet<DemoTest> DemoTests { get; set; }
        public virtual DbSet<DemoTest1> DemoTest1 { get; set; }
        ...
        public virtual DbSet<LoginDev> LoginDevs { get; set; }
        ...
        public virtual int CreateTicketSave(string subject, string url, string details, string screenshotUrl, Nullable<int> priority, string raiseBy, string pfcode, string firmName, Nullable<System.DateTime> dateTime, string status)
        {
            ...
            var screenshotUrlParameter = screenshotUrl != null ?
                new ObjectParameter("ScreenshotUrl", screenshotUrl) :
                new ObjectParameter("ScreenshotUrl", typeof(string));
    
            var priorityParameter = priority.HasValue ?
                new ObjectParameter("Priority", priority) :
                new ObjectParameter("Priority", typeof(int));
    
            var raiseByParameter = raiseBy != null ?
                new ObjectParameter("RaiseBy", raiseBy) :
                new ObjectParameter("RaiseBy", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CreateTicketSave", subjectParameter, urlParameter, detailsParameter, screenshotUrlParameter, priorityParameter, raiseByParameter, pfcodeParameter, firmNameParameter, dateTimeParameter, statusParameter);
        }
        ...
        public virtual ObjectResult<getIssueList_Result> getIssueList(string pfcode)
        {
            var pfcodeParameter = pfcode != null ?
                new ObjectParameter("Pfcode", pfcode) :
                new ObjectParameter("Pfcode", typeof(string));
        ...
        public virtual ObjectResult<getLoginforDev_Result> getLoginforDev(string username, string password)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("username", username) :
                new ObjectParameter("username", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getLoginforDev_Result>("getLoginforDev", usernameParameter, passwordParameter);
        }
